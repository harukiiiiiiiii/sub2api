...
func (s *OpenAIGatewayService) forwardOpenAIPassthrough(
	...
	if account != nil && account.IsOpenAI() {
		...
		normalizedBody, normalized, normalizeErr := normalizeOpenAIResponsesWebSocketCompatibilityBody(body, account, responsesLite, s.defaultImageModelForBody(ctx, body))
		if normalizeErr != nil {

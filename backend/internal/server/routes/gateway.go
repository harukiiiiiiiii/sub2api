...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.POST("/images/batches", middleware.CarpoolModeGuard(cfg), h.BatchImage.Submit)
		gateway.GET("/images/batches", middleware.CarpoolModeGuard(cfg), h.BatchImage.List)
		gateway.GET("/images/batches/models", middleware.CarpoolModeGuard(cfg), h.BatchImage.Models)
		gateway.GET("/images/batches/:id", middleware.CarpoolModeGuard(cfg), h.BatchImage.Get)
		gateway.GET("/images/batches/:id/items", middleware.CarpoolModeGuard(cfg), h.BatchImage.Items)
		gateway.GET("/images/batches/:id/items/:custom_id/content", middleware.CarpoolModeGuard(cfg), h.BatchImage.ItemContent)
		gateway.GET("/images/batches/:id/download", middleware.CarpoolModeGuard(cfg), h.BatchImage.Download)
		gateway.POST("/images/batches/:id/cancel", middleware.CarpoolModeGuard(cfg), h.BatchImage.Cancel)
		gateway.DELETE("/images/batches/:id", middleware.CarpoolModeGuard(cfg), h.BatchImage.DeleteRecord)
		gateway.DELETE("/images/batches/:id/outputs", middleware.CarpoolModeGuard(cfg), h.BatchImage.DeleteOutputs)
